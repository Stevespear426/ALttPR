...
@Composable
fun RandomChallengeView(createChallenge: () -> Unit) {
    ...
    Card(modifier = Modifier.fillMaxWidth().wrapContentHeight()) {
        Column(
            ...
            PrimaryButton(Res.string.create_random) {
                createChallenge()
            }
        }
    }
...
@Composable
fun RandomChallengeViewLightPreview() {
    PreviewLightTheme {
        RandomChallengeView {}
    }
}
...
@Preview(showBackground = true)
@Composable
fun RandomChallengeViewDarkPreview() {
    PreviewDarkTheme {
        RandomChallengeView {}
    }
}
